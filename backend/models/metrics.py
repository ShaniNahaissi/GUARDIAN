...
class FrameMetric(Base):
    ...
    person_latency_ms: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    action_latency_ms: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
...
class SequenceMetric(Base):
    ...
    avg_person_latency_ms: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
    avg_action_latency_ms: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)
